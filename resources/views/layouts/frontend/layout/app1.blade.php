...
<head>
    ...
    <link href="{{ url('/frontend/layout/toastr.css') }}" rel="stylesheet" type="text/css">
...
@include('frontend/partial.header1')
@yield('content')
@include('frontend/partial.footer')
    ...
    <script href="{{ url('/frontend/layout/toastr.js') }}" type="text/javascript"></script>
